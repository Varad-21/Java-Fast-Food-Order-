...
<%@page import="com.fastfood.CartDAO"%>
...
<nav class="navbar navbar-expand-sm"
	style="background-image: url('../static/images/background_textured1.jpg'); border-bottom: 1px solid red">
	<a class="navbar-brand" href="user_home.jsp"
		style="color: white; font-weight: bold">Online Cafeteria</a>
