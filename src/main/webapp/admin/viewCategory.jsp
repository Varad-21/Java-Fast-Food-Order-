<%@page import="com.fastfood.CategoryDAO"%>
<%@page import="com.fastfood.Category"%>
...
<!-- Close Logout Model -->
	...
	%>
		<div class="container card shadow m-5">
			<div class="card-body">
			<a href="addCategory.jsp" class="btn btn-primary float-right btn-sm">Add New Category</a>
				<h5 class="p-2" style="border-bottom: 2px solid orange">View Category</h5>
				...
				<div class="container mt-5">
					...
					<table id="example" class="table table-striped table-bordered" style="width:100%">
						...
						<tbody style="overflow: scroll">
							<%
							    int i=0;
								for (Category c : CategoryDAO.getCategories(false,false)) {
									i++;
							%>
							...
							<tr>
								<td><%=i%></td>
								<td><%=c.getCatname()%></td>
								<td><a href="editCategory.jsp?catid=<%=c.getCatid()%>"
									class="btn btn-sm btn-primary">Edit</a>
								| <a onclick="return confirm('Are you sure to Delete this Category ?')" href="deleteCategory.jsp?catid=<%=c.getCatid()%>"
