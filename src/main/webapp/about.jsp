	...
	<div class="container" style="margin-top: 150px">
		...
		<div class="row">
			<div class="col-sm-4 prjdiv">
				<img src="static/images/abt.jpg" width="300" height="200" class="img-responsive">
			</div>
			<div class="col-sm-8 prjdiv"
				style="font-weight: bold; margin-top: 30px">Hola folks! It
				looks like you are here to know us better. Online Cafeteria is a user
				friendly, easy to use website where one can order fast foods by just
